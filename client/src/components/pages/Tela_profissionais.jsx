...
const Profissionais = () => {
  const menuShow = () => {
    // Lógica para mostrar o menu (ainda não implementada)
  };
  ...
  return (
    <div style={{ backgroundColor: '#E6E6FA', minHeight: '100vh' }}>
      <style>
        ...
        <div className="logo">
          <h1>ViverBem+</h1>
          <a href="pagina_inicial.html" className="nav_link">Página inicial</a>
          <a href="login.html" className="nav_link">Login</a>
        </div>
