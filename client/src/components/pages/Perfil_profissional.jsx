...
import profilePic from './imagens/luisahenringer.jpg'; // ajuste o caminho conforme necessário
            ...
            <section className="intro">
                <div className="container">
                    ...
                    <div className="intro-text">
                        ...
                        <p>
                            Meu nome é Luísa Heringer, e tenho o privilégio de dedicar minha vida ao cuidado dos idosos há 3
                            anos e 6 meses. Minha paixão por esta profissão é impulsionada pela empatia e respeito pelos idosos, e meu objetivo
                            é proporcionar uma qualidade de vida excepcional para aqueles que confiam em meus cuidados.
                        </p>
                    </div>
                </div>
            </section>
